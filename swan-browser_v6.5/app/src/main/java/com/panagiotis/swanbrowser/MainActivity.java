	...
	private void initialize(Bundle _savedInstanceState) {
		...
		binding.webview1.setWebViewClient(new WebViewClient() {
			...
			public void onPageFinished(WebView _param1, String _param2) {
				...
				binding.edittext1.setText(binding.webview1.getUrl());
		...
		binding.button5.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				binding.webview1.stopLoading();
				binding.webview1.clearCache(true);
				if (binding.edittext1.getText().toString().contains("https://")) {
					binding.webview1.loadUrl(binding.edittext1.getText().toString());
				} else {
					if (binding.edittext1.getText().toString().contains(" ")) {
						binding.webview1.loadUrl(search_engine.concat(binding.edittext1.getText().toString()));
					} else {
		...
		binding.circleimageview8.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				binding.linear10.setBackgroundColor(0xFFEFEBE9);
